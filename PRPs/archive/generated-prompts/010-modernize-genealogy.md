# Modernize Genealogy Site Task: add-utf8-charset
...
## Task Overview
**Item:** 010
**Task:** add-utf8-charset
**Description:** Add UTF-8 charset declarations to HTML files
...
## Current Issue
Add UTF-8 charset declarations to HTML files
...
1. **Search ALL subdirectories recursively** - Use Grep with count mode: `<meta` in `docs/htm`
...
grep -r "<meta" docs/htm --include="*.htm" --include="*.html" -l | wc -l

# Count total occurrences
grep -r "<meta" docs/htm --include="*.htm" --include="*.html" -c

# List affected files for verification
grep -r "<meta" docs/htm --include="*.htm" --include="*.html" -l
```
...
- [ ] I have verified I'm working in the correct git branch: `task-010-add-utf8-charset`
...
1. **Verify setup**: Confirm you're in branch `task-010-add-utf8-charset` and tracking shows "IN PROGRESS"
...
## Success Criteria
- All instances of `<meta` are properly addressed
