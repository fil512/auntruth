# Modernize Genealogy Site Task: create-404-page
...
**Description:** Create custom 404.html page
...
1. **Search ALL subdirectories recursively** - Use Grep with count mode: `404.html` in `docs`
...
grep -r "404.html" docs --include="*.htm" --include="*.html" -l | wc -l

# Count total occurrences
grep -r "404.html" docs --include="*.htm" --include="*.html" -c

# List affected files for verification
grep -r "404.html" docs --include="*.htm" --include="*.html" -l
```
...
- [ ] I have verified I'm working in the correct git branch: `task-013-create-404-page`
...
1. **Verify setup**: Confirm you're in branch `task-013-create-404-page` and tracking shows "IN PROGRESS"
...
## Success Criteria
- All instances of `404.html` are properly addressed
