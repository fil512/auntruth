# Broken Links Fix - remove-cgi-counters.py

## Background
This is part of the systematic broken links fix plan for AuntieRuth.com genealogy website. You are working on item 003 of 6 total fixes.

## Task Description
Remove obsolete CGI counter references

**Estimated fixes**: 797 broken links
**Priority**: 3

## Implementation Requirements

### Step 1: Create the Script
Create the script `PRPs/scripts/remove-cgi-counters.py` based on the requirements below.
